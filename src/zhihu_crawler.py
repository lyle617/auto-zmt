...
class zhihuCrawler:
    ...
    def save_answers(self, answers, question_id):
        ...
        with open(file_path, mode='w', newline='', encoding='utf-8') as file:
            ...
            writer.writerow(['Author ID', 'Author Nickname', 'Author Type', 'Author Headline', 'Vote-up Count', 'Thanks Count', 'Comment Count', 'Content'])
...
if __name__ == "__main__":
    ...
    crawler.save_answers(answers, '668753879')
    # if answers:
    #     for answer in answers:
